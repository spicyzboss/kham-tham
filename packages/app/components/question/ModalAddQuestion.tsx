            ...
            <Dialog.Portal>
                ...
                >
                    <YStack space>
                        ...
                        <YStack space="$3">
                            <Button theme="crimson_Button" alignSelf="stretch" onPress={() => selectType("SingleSelect")}>Single Select</Button>
                            <Button theme="crimson_Button" alignSelf="stretch" onPress={() => selectType("MultipleSelect")}>Multiple Select</Button>
                            <Button theme="crimson_Button" alignSelf="stretch" onPress={() => selectType("TypeSelect")}>Text Input</Button>
                        </YStack>
